...
public class JobServiceImpl implements JobService {
    ...
    // By this we do not need to manage the jobRepository object and do not need to
    // create an instance and assigning and initialize.
    ...
    public void createJob(Job job) {
        // job.setId(nextId++); // (By this we can get full control over id rather than
