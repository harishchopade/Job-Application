...
// (If class Level RequestMapping() annotation is given and want to direct on that URL)
    //    @GetMapping()   
    ...
    @GetMapping("/jobs/{id}")
    public ResponseEntity<Job> getJobById(@PathVariable long id){ // variable pass in GetMapping should exact match with parameter passed
